  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto flex justify-between items-center px-6 md:px-8 py-4">
        <a href="#" className="font-headline font-black text-xl tracking-tighter" style={{ color: "var(--c-on-surface)" }}>
          VibeWebStudio
        </a>
  ...
  return (
    <footer style={{ background:"var(--c-surface)", borderTop:"1px solid rgba(72,71,77,0.12)", padding:"4rem 1.5rem" }}>
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-start gap-12">
        <div>
          <div className="font-headline font-black text-xl tracking-tighter mb-3 footer-logo">VibeWebStudio</div>
