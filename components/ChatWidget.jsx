...
function Bubble({ msg }) {
  ...
  return (
    <div className={`flex gap-3 mb-4 ${isUser ? "flex-row-reverse" : "flex-row"}`}>
      {!isUser && (
        <div className="w-8 h-8 rounded-lg flex items-center justify-center flex-shrink-0 mt-1 font-black text-xs"
          style={{ background: "linear-gradient(135deg,#874cff,#00cffc)", color: "#fff" }}>V</div>
      )}
