...
const INTENTS = [
  {
    ...
    keywords: [
      ...
      "good evening", "sup", "whats up", "greetings", "yo", "hiya", "namaste",
    ],
    replies: [
  ...
  },
  {
    name: "pricing",
    keywords: [
      "price", "cost", "budget", "rate", "charge", "fee", "how much",
      "expensive", "cheap", "afford", "rates", "quote", "pricing", "payment",
      "pay", "investment", "worth", "money", "rupee", "dollar", "inr",
    ],
    replies: [
      ...
      "Great question! Here's a rough guide:\n\n• Simple landing pages start ₹5K\n• Full business websites from ₹10K\n• E-commerce from ₹60K\n• Apps are scoped individually\n\nFor a precise quote tailored to your project, use our **contact form**. It only takes 2 minutes! 🎯",
      "We believe in transparent pricing. Depending on project complexity:\n\n• Landing pages: ₹15K–₹30K\n• Websites: ₹40K–₹1.5L\n• E-commerce: ₹60K+\n• Web apps: custom quote\n\nDrop your details in the **contact form** and we'll send a custom estimate! 💬",
    ],
    contextReplies: {
      ...
      services: "Glad you know what we offer! Now for pricing:\n\n• Landing pages from ₹15K\n• Full sites from ₹40K\n• E-commerce from ₹60K\n\nFill out the **contact form** for a real quote on your specific needs. 🚀",
      start_project: "Perfect timing to talk pricing! The exact cost depends on your scope. Use our **contact form** to tell us about your project and we'll send a precise quote within 48 hours.",
    },
  },
  {
    name: "timeline",
    keywords: [
      "timeline", "time", "long", "duration", "deadline", "how fast", "when",
      "days", "weeks", "months", "quick", "speed", "fast", "urgent", "delivery",
      "turnaround", "eta", "complete", "finish", "ready",
    ],
    replies: [
      ...
      "We're known for hitting deadlines! Rough guide:\n\n• Landing page: ~1–2 weeks\n• Full website: 3–5 weeks\n• E-commerce: 4–7 weeks\n• Complex app: 6+ weeks\n\nHave a specific date in mind? Let us know via the **contact form** and we'll confirm availability. 📅",
    ...
    contextReplies: {
      ...
      start_project: "Ready to start? Timeline depends on your project type. Landing pages take 1–2 weeks, full websites 3–5 weeks. Share your expected launch date in the **contact form** and we'll plan around it!",
    },
  },
  {
    name: "services",
    keywords: [
      "service", "offer", "build", "create", "make", "develop", "design",
      "what do you do", "do you", "can you", "capabilities", "specialize",
      "expertise", "help with", "web", "website", "app", "ecommerce", "seo",
      "branding", "landing", "store", "application", "dashboard", "saas",
    ],
    replies: [
      ...
      "We specialize in modern, high-performance web products — from sleek landing pages to complex web apps. Design, development, e-commerce, SEO — we handle it all. What does your project need?",
    ],
    contextReplies: {},
  },
  {
    name: "portfolio",
    keywords: [
      "portfolio", "work", "project", "example", "previous", "case study",
      "samples", "show me", "see", "done", "built", "made", "client", "past",
      "reference", "showcase",
    ],
    replies: [
      ...
      "We've built everything from sleek SaaS dashboards to full e-commerce platforms. Scroll through the **Projects section** on our homepage to see live examples. Have a specific style or industry in mind?",
      "Great — our work is right here on the site! Browse the **Projects section** to see client projects. Want us to walk you through a case study? Use the **contact form** and we'll share relevant samples directly.",
    ],
    contextReplies: {},
  },
  {
    name: "contact",
    keywords: [
      "contact", "email", "reach", "talk", "call", "connect", "speak",
      "get in touch", "message", "form", "touch", "discuss", "consultation",
      "meeting", "response", "reply", "hear from", "support",
    ],
    replies: [
      ...
      "We'd love to connect! The fastest route is our **contact form** right here — we typically reply within 1 business day. You can also email **vibewebstudio91@gmail.com** directly. 🙌",
  ...
  },
  {
    name: "start_project",
    keywords: [
      "start", "begin", "hire", "work together", "ready", "lets go", "let's go",
      "kickoff", "kick off", "onboard", "get started", "move forward", "proceed",
      "book", "commission", "engage", "project", "collaborate", "partnership",
    ],
    replies: [
      ...
      "Great decision! To get the ball rolling:\n\n• Fill out the **contact form** below\n• Share your vision, timeline & budget\n• We'll send a custom proposal within 2 business days\n\nWe're excited to hear about your project! 🙌",
    ],
    contextReplies: {
  ...
  },
  {
    name: "tech_stack",
    keywords: [
      "technology", "tech", "stack", "react", "next", "nextjs", "wordpress",
      "shopify", "woocommerce", "platform", "framework", "language", "code",
      "programming", "html", "css", "javascript", "typescript", "node",
    ],
    replies: [
      ...
      "Great question! We're framework-agnostic and pick the best tool for the job:\n\n• **Next.js / React** — Fast, SEO-ready apps\n• **Shopify** — E-commerce powerhouse\n• **WordPress** — Content-driven sites\n• **Node.js** — Scalable backends\n\nNeed something specific? Mention it when you **contact us**!",
    ],
    contextReplies: {},
  },
  {
    name: "revisions",
    keywords: [
      "revision", "change", "update", "edit", "modify", "feedback",
      "iteration", "revision policy", "how many", "unlimited", "changes",
      "alter", "tweak", "adjust", "rework",
    ],
    replies: [
      ...
      "We're committed to getting it right! Standard packages include 2–3 revision rounds. We do scheduled feedback sessions to keep things efficient. More detail on a specific scope? Use the **contact form** to discuss. 🎨",
    ],
    contextReplies: {},
  },
  {
    name: "quality",
    keywords: [
      "quality", "good", "best", "reliable", "trust", "professional",
      "experience", "years", "expert", "skilled", "team", "who are you",
      "about", "guarantee", "assurance",
    ],
    replies: [
      "Quality is at the core of everything we do! ✨ VibeWebStudio is a premium web studio delivering:\n\n• Pixel-perfect, modern designs\n• Clean, scalable code\n• SEO-optimized by default\n• Fast load times (Core Web Vitals compliant)\n• Post-launch support\n\nWe're not just vendors — we're your digital growth partners. 🤝",
      "Great question! We take quality seriously:\n\n• Every project goes through design review, code review & QA\n• We follow best practices for performance, accessibility & SEO\n• We communicate transparently throughout\n\nExplore our **Projects** section to see the output quality for yourself!",
    ],
    contextReplies: {},
  },
];
...
const FALLBACKS = [
  ...
  "I didn't quite catch that — sorry! Try asking about our **services**, **pricing**, **how fast** we work, or **how to start a project**. Or just fill out the **contact form** for a personal response. 😊",
...
// Suggestion sets (rotated based on context)
...
function scoreIntent(intent, normalized) {
  ...
  for (const kw of intent.keywords) {
    if (normalized.includes(kw)) {
      score += kw.split(" ").length; // phrase matches score more
    }
  }
  return score;
}
...
function resolveIntent(input, lastIntent) {
  ...
  if (!best || bestScore === 0) {
    return { intent: null, reply: pick(FALLBACKS) };
  }

  // Context-aware override
  if (lastIntent && best.contextReplies?.[lastIntent]) {
    return { intent: best.name, reply: best.contextReplies[lastIntent] };
  }
...
function typingDelay(text) {
  return Math.min(700 + text.length * 10, 2400);
}
...
function renderText(text) {
  return text.split(/(\*\*[^*]+\*\*)/).map((part, i) => {
    if (part.startsWith("**") && part.endsWith("**")) {
      return (
        <strong key={i} style={{ color: "#f0edf5", fontWeight: 600 }}>
          {part.slice(2, -2)}
        </strong>
      );
    }
...
const STYLES = `
  ...
  @keyframes vws-panel-in {
    from { opacity: 0; transform: scale(0.96) translateY(8px); }
    to   { opacity: 1; transform: scale(1)    translateY(0); }
  }
  @keyframes vws-badge-pulse {
    0%, 100% { box-shadow: 0 0 0 0 rgba(99,179,237,0.5); }
    50%       { box-shadow: 0 0 0 5px rgba(99,179,237,0); }
  }

  .vws-wrap *  { box-sizing: border-box; font-family: 'DM Sans', sans-serif; }
  .vws-wrap    { font-family: 'DM Sans', sans-serif; }
  ...
  .vws-fab:hover {
    ...
    box-shadow: 0 6px 32px rgba(0,0,0,0.45), 0 1px 4px rgba(0,0,0,0.2);
  }
...
function Bubble({ msg }) {
  ...
  return (
    <div
      className={isUser ? "vws-bubble-user" : "vws-bubble-ai"}
      style={{
        display: "flex",
        gap: 10,
        marginBottom: 16,
        ...
        {[0, 1, 2].map((i) => (
          <span
            ...
            style={{
              ...
              animation: "vws-dot 1.2s ease-in-out infinite",
...
export default function ChatWidget() {
  ...
  const send = useCallback(async (textOverride) => {
    ...
    // Resolve intent client-side (no network call)
    ...
    if (intent) {
      ...
      setSuggestions(SUGGESTION_SETS[intent] ?? SUGGESTION_SETS.default);
    } else {
      setSuggestions(SUGGESTION_SETS.default);
    }
  }, [input, loading, lastIntent]);

  // Show suggestions only when few messages and not loading
  ...
  return (
    <div className="vws-wrap">
      ...
      >
        ...
        >
          <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
            ...
            <div>
              <p style={{ color: "#f0edf5", fontWeight: 600, fontSize: 13, lineHeight: 1, margin: 0, letterSpacing: "-0.01em" }}>
                Vibe
              </p>
              <div style={{ display: "flex", alignItems: "center", gap: 5, marginTop: 3 }}>
                <span style={{ width: 6, height: 6, borderRadius: "50%", background: "#68d391", display: "inline-block" }} />
                <p style={{ color: "rgba(255,255,255,0.35)", fontSize: 11, margin: 0, letterSpacing: "0.02em" }}>
                  VibeWebStudio · Instant replies
                </p>
              </div>
            </div>
          </div>
        ...
        {/* Messages */}
        <div
          className="vws-messages"
          style={{ flex: 1, overflowY: "auto", padding: "16px 14px 0" }}
        >
        ...
        {showSuggestions && (
          <div style={{ padding: "8px 14px 0", flexShrink: 0 }}>
            <div className="vws-suggestions-row">
              {suggestions.map((s) => (
                <button key={s} className="vws-suggestion" onClick={() => send(s)}>
                  {s}
                </button>
              ))}
            </div>
        ...
        >
          ...
          <button
            ...
            aria-label="Send"
          >
            <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="#0f0f14" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round">
      ...
      >
        {open ? (
          <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#0f0f14" strokeWidth="2.5">
            <path d="M18 6 6 18M6 6l12 12" />
          </svg>
        ) : (
          <svg width="20" height="20" viewBox="0 0 24 24" fill="#0f0f14">
        ...
        {unread && !open && (
          <span
            style={{
              ...
              animation: "vws-badge-pulse 2.5s ease-in-out infinite",
            }}
          />
        )}
      </button>
