        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-14">
          {PROJECTS.map((p, i) => (
            <button
              ...
              style={{
                background:"var(--c-sc-high)", display:"block", cursor:"pointer", width:"100%",
            ...
            >
              ...
              {/* Expand icon — shown via CSS: .project-card:hover .port-expand { opacity: 1 } in globals.css */}
              <div className="port-expand" aria-hidden="true"
                style={{
        ...
        >
          <div className="modal-content relative max-w-2xl w-full rounded-3xl overflow-hidden"
            ...
            <div className="p-8">
              ...
              <button
                onClick={(e) => { createRipple(e); setSelected(null); scrollTo("contact"); }}
