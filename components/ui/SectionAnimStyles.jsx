...
import GalaxyBackground from "@/components/ui/ShootingStars";
  ...
  return (
    <section
      ...
      style={{
        ...
        position: "relative",
        overflow: "hidden",
        /* No background here — canvas paints its own #07070f */
      }}
    >
      <GalaxyBackground />

      <div className="svc-dot" aria-hidden="true" style={{ position:"absolute", width:400, height:400, borderRadius:"50%", top:"0%", right:"-8%", background:"rgba(187,158,255,0.10)", filter:"blur(100px)", pointerEvents:"none" }} />
      <div className="svc-dot" aria-hidden="true" style={{ position:"absolute", width:280, height:280, borderRadius:"50%", bottom:"5%", left:"-5%", background:"rgba(0,207,252,0.08)", filter:"blur(80px)", pointerEvents:"none", animationDelay:"2s" }} />
